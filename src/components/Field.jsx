...
const defaultStyle = (mobileMax, value) => ({
  width: mobileMax ? "85.7%" : "100%",
  ...
  "& label": {
    ...
    opacity: value ? 0 : 1,
    marginBottom: mobileMax ? "8px" : "20px",
  },
  ...
  "& input": {
    paddingTop: 0,
    paddingBottom: mobileMax ? "8px" : "20px",
    height: "auto",
  },
...
export const Field = ({
  ...
  return (
    <TextField
      sx={defaultStyle(mobileMax, value)}
      error={error}
      type={type}
      id={id}
      label={label}
